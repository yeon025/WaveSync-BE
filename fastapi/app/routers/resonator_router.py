...
@router.post("", response_model=ApiResponse[CreateResonatorResponse], response_model_exclude_none=True, status_code=200)
...
@router.get("", response_model=ApiResponse[List[ResonatorSummaryResponse]], response_model_exclude_none=True, status_code=200)
...
@router.get("/{user_resonator_id}", response_model=ApiResponse[ResonatorDetailResponse], response_model_exclude_none=True, status_code=200)
...
@router.get("/{user_resonator_id}/setting", response_model=ApiResponse[ResonatorSettingResponse], response_model_exclude_none=True, status_code=200)
