...
from app.schemas.common import StatDto


# Spring entity.ResonanceNodeMaster.getStat() 대응.
# DB I/O 없이 이미 로드된 ResonanceNodeMaster의 필드 중 하나를 골라 StatDto로
...
def get_stat(
    ...
    if branch_position in (BranchPosition.LEFT_OUTER, BranchPosition.RIGHT_OUTER):
        ...
        return StatDto(type=node_master.outer_node_type, value=value)
    ...
    if branch_position in (BranchPosition.LEFT_INNER, BranchPosition.RIGHT_INNER):
        ...
        return StatDto(type=node_master.inner_node_type, value=value)
